    ...
    modal && (
      <div onClick={onClickSearch} className="absolute flex items-center justify-end gap-2 inset-0 pl-5 bg-black">
        <div className="w-full">
          <input type="text" ref={inputRef} placeholder="Search..." className="text-white border bg-black/10 border-white/50 rounded-full px-4 py-2.5 w-full shadow-lg shadow-white/30 focus:outline-blue-600/75"/>
        </div>

...
function CurrentNews() {
  return (
    <div className="overflow-hidden mt-6 relative">
      ...
      <div className="bg-gray-600/30 border border-white/30 mx-12 rounded-xl h-16 text-white text-2xl font-bold flex justify-center items-center backdrop-blur-3xl">

...
function NavBar() {
  ...
  return (
    <div className='z-50 bg-white/25 border border-white/30 mx-28 mt-12 rounded-xl flex justify-between px-5 backdrop-blur-2xl'>
            ...
            <div ref={dropdownRef} className='flex items-center gap-5'>
                    <div className={`text-white text-[18px] border px-1 py-1 rounded-full shadow-xl ${openCountry ? "border-white" : "shadow-white/25 border-white/60"}`} onClick={dropDownCountry}>
                    ...
                    <div className={`text-white text-[18px] border px-1 py-1 rounded-full shadow-xl ${openCategory ? "border-white" : "shadow-white/25 border-white/60"}`} onClick={dropDownCategory}>
                        <div className='hover:bg-white/25 flex items-center gap-1 px-4 py-0.5 rounded-full'>
                            <p>Category</p>
            ...
            <div className='border border-white/40 flex my-3 mr-4 rounded-full px-3 py-1 text-white items-center gap-2 focus-within:border-white/70 focus-within:bg-white/10 transition'>
                ...
                <input type="text" placeholder="Search..." className='bg-transparent outline-none border-none focus:ring-0 w-full placeholder-white/60 rounded-full px-2'/>
            </div>
    </div>
  )
}
